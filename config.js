const config = {
  ...
  "hadesTech" : {
    ...
    "cargobay": {desc: "Trade - Cargo Bay Extension", group: "trade", redditURL: "modules/cargo_bay_extension", levels: [1,4,15,50,100,250,500,1000,2000,4000,8000]},
...
//    "autopilot": {desc: "Trade - Shipment Autopilot", group: "trade", redditURL: "modules/shipment_autopilot", levels: [150,230,360,550,850,1300,2000,5000,8000]},
    ...
    "miningboost": {desc: "Mining - Mining Boost", group: "mining", redditURL: "modules/mining_boost", levels: [2,4,25,50,100,250,500,1000,2000,4000]},
    ...
    "hydrogenrocket": {desc: "Mining - Hydrogen Rocket", group: "mining", redditURL: "modules/hydrogen_rocket", levels: [2000,2250,2500,3000,3500,4000,4500,5000,6000,8000]},
